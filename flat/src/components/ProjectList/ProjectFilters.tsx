    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base transition-all hover:bg-white"
        />
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <select 
          ...
          className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg font-medium text-sm text-gray-700 hover:bg-gray-100 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
