...
export const DATABASE_CONFIG = {
  ...
  VERSION_HISTORY: {
    ...
    '1.2.0': 'Updated User Role system - ADMIN, INTERNAL_MANAGER, EXTERNAL_MANAGER, CUSTOMER',
    '1.3.0': 'Added more Manager roles and updated Customer data with real cosmetic companies'
  }
} as const;
