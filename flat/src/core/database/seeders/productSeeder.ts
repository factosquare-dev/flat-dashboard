import { ProductStatus, type Product, type ProductId } from '@/shared/types/product';
import type { ProductCategoryId } from '@/shared/types/productCategory';
import { getCurrentISOString } from '@/shared/utils/unifiedDateUtils';
