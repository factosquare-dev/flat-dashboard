import { Schedule, Task, TaskStatus, Participant } from '@/shared/types/schedule';
import { Project, ProjectStatus } from '@/shared/types/project';
import { User, UserRole } from '@/shared/types/user';
import { taskTypesByFactoryType } from '@/core/database/factories';
import { parseDate, toLocalDateString, getTaskStatusByDate } from '@/shared/utils/unifiedDateUtils';
