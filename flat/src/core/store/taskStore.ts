...
import type { Task, Schedule } from '@/shared/types/schedule';
import type { Project } from '@/shared/types/project';
import { scheduleApi } from '@/core/api/scheduleApi';
import { TaskStatus } from '@/shared/types/enums';
import { ProjectNotFoundError, assertDefined } from '@/shared/utils/error';
    ...
    (set, get) => ({
      ...
      updateTask: async (projectId: string, taskId: string | number, updates: Partial<Task>) => {
        ...
        try {
          ...
          // MockDatabase에도 업데이트
          const { MockDatabaseImpl } = await import('../database/MockDatabase');
