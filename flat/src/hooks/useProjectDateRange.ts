...
/**
 * Custom hook to get project date range from MockDatabase
 * Returns the earliest start date and latest end date from all projects with padding
 */
export const useProjectDateRange = (): DateRange => {
  return useMemo(() => {
    try {
      ...
      console.error('[useProjectDateRange] Error getting dates from MockDB:', errorMessage, error);
    }
