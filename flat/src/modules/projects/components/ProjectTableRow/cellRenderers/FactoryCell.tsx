...
import type { UseEditableCellReturn } from '@/shared/hooks/useEditableCell';
import { FactoryType, ProjectType, ProjectFactoryField, ProjectFactoryIdField, FactoryFieldToType, FactoryTypeLabel } from '@/shared/types/enums';
import { mockDataService } from '@/core/services/mockDataService';
import { formatManufacturerDisplay } from '@/shared/utils/companyUtils';
