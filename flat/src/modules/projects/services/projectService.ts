...
import type { Project, ProjectFilter, ProjectFormData, ProjectMetrics } from '@/shared/types';
import type { ApiResponse, PaginationParams, SortParams } from '@/common/types';
import type { Project as ProjectModel, ProjectType } from '@/shared/types/project';
import type { 
  ProjectsResponse, 
  ProjectResponse, 
