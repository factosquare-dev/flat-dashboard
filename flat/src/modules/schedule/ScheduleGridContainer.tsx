...
import type { ScheduleFactory, Task, TaskControls, DragControls, ModalState } from '@/shared/types/schedule';
...
import { getInteractionState, setInteractionMode, setPreventClickUntil } from '@/shared/utils/schedule/globalState';
