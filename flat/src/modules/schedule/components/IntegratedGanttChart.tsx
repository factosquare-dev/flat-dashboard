...
import ProjectSidebar from '@/modules/schedule/ProjectSidebar';
import GanttGrid from '@/modules/schedule/GanttGrid';
import TaskRenderer from '@/modules/schedule/TaskRenderer';
import { useGanttDrag } from '@/modules/schedule/hooks/useGanttDrag';
import type { Project } from '@/GanttChart/types';
import { getTotalRows } from '@/modules/schedule/utils/ganttHelpers';
