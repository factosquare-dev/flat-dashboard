...
import type { ScheduleFactory, Task } from '@/shared/types/schedule';
import type { Factory } from '@/shared/types/factory';
import { getDaysArray } from '@/shared/utils/scheduleUtils';
import { formatDate } from '@/shared/utils/coreUtils';
import { useScheduleDrag } from '@/shared/hooks/useScheduleDrag';
import { useScheduleTasks } from '@/shared/hooks/useScheduleTasks';
import { useScheduleTasksWithStore } from '@/shared/hooks/useScheduleTasksWithStore';
import { factories } from '@/core/database/factories';
import { storageKeys } from '@/config';
import { parseScheduleDate } from '@/shared/utils/scheduleDateParsing';
import { addDays, startOfDay } from 'date-fns';
import { getParticipantColor } from '@/shared/utils/scheduleColorManager';
import { useProjectFactories } from '@/shared/hooks/useProjectFactories';
