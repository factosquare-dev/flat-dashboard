import type { Task, ResizePreview, ModalState } from '@/shared/types/schedule';
import { setInteractionMode, setPreventClickUntil } from '@/shared/utils/schedule/globalState';
import { SCHEDULE_CONSTANTS } from '@/modules/schedule/constants';
