...
import { ProjectStatus, Priority, ServiceType, ProductType, ProjectType } from '@/shared/types/enums';
...
import { SIMULATION_CONSTANTS } from '@/shared/hooks/useProjects/helpers/projectHelpers';
